...
- **필요한 오디오 소스 녹음:** 마이크를 별도로 선택한 뒤 마이크, 시스템 오디오 또는 둘을 함께 녹음하고, 세션을 끝내지 않은 채 녹음 중에 소스를 전환합니다.
...
녹음 중 Quill이 예기치 않게 종료되면 복구 가능한 오디오가 로컬 앱 저장소에 남을 수 있습니다. 복구되었거나 일부만 복구된 녹음은 사용자가 전사를 재시도하거나 삭제할 때까지 로컬에 유지됩니다. 앱 시작 시 복구 과정은 해당 오디오를 자동으로 전사하거나 업로드하지 않습니다. **전사 재시도**를 선택하면 설정에서 선택한 로컬 또는 제공자 기반 전사 경로를 사용합니다.
